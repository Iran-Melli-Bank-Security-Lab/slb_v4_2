  ...
  return (
    <Card className="mb-8 shadow-lg rounded-xl overflow-hidden">
      ...
      <CardContent className="p-6">
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            <Box className="p-4 bg-gray-50 rounded-lg h-full">
              <Typography variant="h5" className="font-semibold mb-4 text-gray-800 flex items-center">
                ...
                {projectData.team.map((member, index) => (
                  <ListItem key={index} className="pl-0 pr-0 py-2">
                    ...
                    <ListItemText
                      ...
                      slotProps={{ secondary: { className: "text-gray-500" } }}
                    />
                    <Chip
        ...
        {/* Technologies */}
        <Box className="mt-6">
          <Typography variant="subtitle1" className="font-medium text-gray-700 mb-3 flex items-center">
...
// ✅ Memoize entire component if its props are stable

...
const UserReportDetails = () => {
  ...
  const isDeleteDisabled = reports?.state !== "New";
        ...
        <div className="space-y-6">
            ...
            >
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex space-x-2">
                    <StatusBadge status={reports.state} />
                    <SeverityBadge severity={reports.severity} />
                  </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 text-sm text-gray-600">
                  <div>
                    <span className="font-medium">CVSS:</span> {reports.CVSS}
                  </div>
                  <div>
                ...
                <div className="space-y-4">
                  ...
                  {reports.path && (
                    <div className="text-sm text-gray-600">
                      <span className="font-medium">Path:</span> {reports.path}
                    </div>
                  )}
                  ...
                  <div className="mt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                      <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
                        ...
                        {reports.securingByOptions.webServerSettings ? (
                      ...
                      <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
                        ...
                        {reports.securingByOptions.modificationInProgramCode ? (
                          <span className="text-green-600">Yes</span>
                        ) : (
                          <span className="text-red-600">No</span>
                        )}
              ...
              <div className="mt-6 pt-4 border-t border-gray-200">
                <div className="flex flex-col sm:flex-row-reverse justify-between items-start sm:items-center gap-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-lg p-4">
...
<div className="flex gap-2">
  ...
  {reports?.pentester === userId && (
    <button
      onClick={() => handleDeleteClick(reports)}
      disabled={isDeleteDisabled}
      className={`inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-red-500 to-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all duration-150 transform ${
        isDeleteDisabled
